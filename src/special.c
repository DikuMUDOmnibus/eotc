...
bool spec_clan_guard( CHAR_DATA *ch )
{
	...
	/* say something, then move em out */
		...
		default : message = NULL;
			break;
		case 0: message = "$n says 'Thou shalt not barbeque on sunday'\n\r";
			break;
		case 1: message = "$n looks at you and cackles wildly!\n\r";
			break;
		case 2: message = "$n asks 'Do they call you Unforgiven?'\n\r";
			break;
		case 3: message = "$n says 'Thou shalt not enjoy false Jeremias'\n\r";
			break;
		case 4: message = "$n says 'Thou shalt not covet thy neighbors baby backs'\n\r";
			break;	
		case 5: message = "$n says 'Do not take the name of Jeremias in vain'\n\r";
			break;
