...
#define QUEST_ITEM1 10909 // Ruby Blood Amulet Haste
#define QUEST_ITEM2 10910 // red dragonscale shield
#define QUEST_ITEM3 3034 // beholder blade
#define QUEST_ITEM4 10911 // decanter endless water
#define QUEST_ITEM5 8325 // chair comfy
#define QUEST_ITEM6 10912 // shadow aura
#define QUEST_ITEM7 10913 // emerald breastplate
...
#define QUEST_OBJQUEST1 3035 // Shield of the Cyclops
#define QUEST_OBJQUEST2 3036 // Crown of the Cyclops
#define QUEST_OBJQUEST3 3037 // Sword of the Cyclops
#define QUEST_OBJQUEST4 3038 // Sceptre of the Cyclops
#define QUEST_OBJQUEST5 3048 // Amulet of the Cyclops
...
void do_quest(CHAR_DATA *ch, char *argument)
{
    ...
    if (arg1[0] == '\0')
    {
        send_to_char("QUEST commands: POINTS INFO TIME REQUEST RESIGN COMPLETE LIST BUY.\n\r",ch);
    ...
    if (!strcmp(arg1, "resign"))
    {
        send_to_char("You resign your current Quest. You may now quest again.\n\r", ch);
	ch->nextquest = 0;
	ch->countdown = 0;
...
850qp..........Ivory Beholder Blade\n\r\
750qp..........Ruby Blood Amulet(haste)\n\r\
750qp..........Red DragonScale Shield(sanctuary)\n\r\
750qp..........Emerald Breastplate(regeneration)\n\r\
750qp..........Shadow Aura(imp. vision)\n\r\
...
To buy an item, type 'QUEST BUY <item>'.\n\r");
    ...
    else if (!strcmp(arg1, "buy"))
    {
        ...
        else if (is_name(arg2, "emerald breastplate"))
        {
            if (ch->questpoints >= 750)
            {
                ch->questpoints -= 750;
        ...
        else if (is_name(arg2, "shadow aura"))
        {
            if (ch->questpoints >= 750)
            {
                ch->questpoints -= 750;
        ...
        else if (is_name(arg2, "ivory beholder blade"))
        {
...
bool quest_level_diff(int clevel, int mlevel)
{
    ...
    else if (clevel > 6 && clevel < 20 && mlevel < 20) return TRUE;
    else if (clevel > 19 && clevel < 60 && mlevel > 20 && mlevel < 60) return TRUE;
    else if (clevel > 59 && clevel < 100 && mlevel > 60 && mlevel < 100) return TRUE;
    else if (clevel > 99 && clevel  < 199 && mlevel > 100 && mlevel < 200) return TRUE;
    else if (clevel > 200 && mlevel > 200) return TRUE;
    else return FALSE;
}
    ...
    for ( d = descriptor_list; d != NULL; d = d->next )
    {
        ...
        else if (IS_SET(ch->act,PLR_QUESTOR))
        {
            if (--ch->countdown <= 0)
            {
                ...
                ch->nextquest = 10;
                sprintf(buf, "You have run out of time for your quest!\n\r You may quest again in %d minutes.\n\r",ch->nextquest);
                send_to_char(buf, ch);
                REMOVE_BIT(ch->act, PLR_QUESTOR);
                ch->questgiver = NULL;
                ch->countdown = 0;
